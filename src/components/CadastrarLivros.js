  ...
  render(){
    ...
    return (
      <form onSubmit={this.handleLivroForm}>
        ...
        <p>
          <label htmlFor='fisbn'>ISBN: Formato - (<span style={{color:'red'}}>978-85-7522-XXX-X</span>)</label>
          <input
          type='text'
          autoFocus
          ...
          id='fisbn'
          required
          // pattern='ˆ978-85-7522-[0-9]{3}-[0-9]{1}$'
          value={this.state.livro.isbn} onChange={e => this.setState({livro:{
            ...this.state.livro, isbn: e.target.value
          }})}
          />
        </p>
        <p>
          ...
          onChange={e => this.setState({livro:{
            ...this.state.livro, titulo: e.target.value
          }})}
          />
        </p>
        <p>
          ...
          onChange={e =>this.setState({
            livro:{
              ...this.state.livro, autor: e.target.value
            }
          })}
          />
        </p>
